...
{
    public class GetReviewsByHostQueryHandler : IQueryHandler<GetReviewsByHostQuery, PaginationResult<ReviewDto>>
    {
        private readonly IReviewRepository _reviewRepository;
        private readonly IUserServiceClient _userServiceClient;
        private readonly IMapper _mapper;

        public GetReviewsByHostQueryHandler(
        ...
        public async Task<PaginationResult<ReviewDto>> Handle(GetReviewsByHostQuery request, CancellationToken cancellationToken)
        {
            var specification = new ReviewByHostIdSpecification(request.HostId);
